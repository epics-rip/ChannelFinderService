...
public class ChannelManager {
     ...
     * @throws SQLException
     */
    public void addTag(String tag, XmlChannels data) throws SQLException {
        String owner = DbOwnerMap.getInstance().enforcedPropertyOwner(tag, data);
        if (owner == null) {
            throw new WebServiceException("Payload tag ownership inconsistent");
        }
     ...
     * @throws SQLException
     */
    public void putTag(String tag, XmlChannels data) throws SQLException {
        String owner = DbOwnerMap.getInstance().enforcedPropertyOwner(tag, data);
        if (owner == null) {
            throw new WebServiceException("Payload tag ownership inconsistent");
        }
     ...
     * @throws SQLException
     */
    public void addSingleTag(String tag, String channel, XmlChannel data) throws SQLException {
